function Schedule(options) {
    ...
    schedule.addCaptionOverline = function() {
        // provide some user instructions at top of page
        schedule.$container.append('<p class="overline"><i class="fa fa-cc"></i> icon indicates sessions with <a href="/transcription/">live captions</a> available to stream on your laptop or device</p>');
    }
